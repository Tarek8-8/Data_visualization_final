# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 14:41:12 2024
...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 01:25:15 2024
...
layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    dbc.Container([
        dbc.Row([
            ...
            dbc.Col(html.H1("Price Distribution Across Furnishing Status", style={'textAlign': 'center', 'color': colors['text']}), 
                    className="mb-5 mt-5")
        ]),
        html.Div([
            # Graph component
            dcc.Graph(
                id='scatter2',
                figure=px.scatter(loc_data, x='area', y='price', color='mainroad',
             labels={'area': 'House Area in Km*2', 'price': 'Price in $'})
            )
